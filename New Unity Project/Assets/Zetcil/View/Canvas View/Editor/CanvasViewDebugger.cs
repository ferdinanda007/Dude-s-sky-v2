...
namespace Zetcil
{
    public class CanvasViewDebugger : EditorWindow
    {
        ...
        [MenuItem("Zetcil/Framework Debugger/Canvas View %F2", false, 6032)]
        private static void OpenWindow()
        {
            CanvasViewDebugger window = GetWindow<CanvasViewDebugger>();
        ...
        public bool FunctionValidation(GameObject targetObject, out int aColor, out int aObject, Vector2 aInMPos, out Vector2 aOutMPos, Vector2 aInCPos, out Vector2 aOutCPos, Vector2 aInVPos, out Vector2 aOutVPos)
        {
            ...
            //-- VIEW Group
            else if (targetObject.GetComponent<UIText>())
            {
                if (targetObject.GetComponent<UIText>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<UIText>().HealthVariables != null ||
                        targetObject.GetComponent<UIText>().ManaVariables != null ||
                        targetObject.GetComponent<UIText>().ExpVariables != null ||
                        targetObject.GetComponent<UIText>().TimeVariables != null ||
                        targetObject.GetComponent<UIText>().ScoreVariables != null ||
                        targetObject.GetComponent<UIText>().IntVariables != null ||
                        targetObject.GetComponent<UIText>().FloatVariables != null ||
                        targetObject.GetComponent<UIText>().StringVariables != null ||
                        targetObject.GetComponent<UIText>().BoolVariables != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<UISkill>())
            {
                if (targetObject.GetComponent<UISkill>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<UISkill>().ActionStatus != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<UISelector>())
            {
                if (targetObject.GetComponent<UISelector>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<UISelector>().SelectorStatus != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<UIList>())
            {
                aColor = ORANGE;
                if (targetObject.GetComponent<UIList>().TargetText != null &&
                    targetObject.GetComponent<UIList>().ListVariables != null)
                {
                    aColor = GREEN;
                }
                else { aColor = RED; }
            ...
            else if (targetObject.GetComponent<UIImage>())
            {
                if (targetObject.GetComponent<UIImage>().isEnabled)
                {
                    aColor = ORANGE;
                    if (targetObject.GetComponent<UIImage>().TargetImage != null &&
                        targetObject.GetComponent<UIImage>().BasePath != null &&
                        targetObject.GetComponent<UIImage>().ImageFileName != null)
                    {
                        aColor = GREEN;
                    }
                }
            ...
            else if (targetObject.GetComponent<UIHealth>())
            {
                aColor = ORANGE;
                if (targetObject.GetComponent<UIHealth>().HealthVariables != null ||
                    targetObject.GetComponent<UIHealth>().ManaVariables != null ||
                    targetObject.GetComponent<UIHealth>().ExpVariables != null ||
                    targetObject.GetComponent<UIHealth>().TimeVariables != null ||
                    targetObject.GetComponent<UIHealth>().ScoreVariables != null ||
                    targetObject.GetComponent<UIHealth>().IntVariables != null ||
                    targetObject.GetComponent<UIHealth>().FloatVariables != null ||
                    targetObject.GetComponent<UIHealth>().StringVariables != null ||
                    targetObject.GetComponent<UIHealth>().BoolVariables != null)
                {
                    aColor = GREEN;
                }
                else { aColor = RED; }
            ...
            else if (targetObject.GetComponent<UIGauge>())
            {
                aColor = ORANGE;
                if (targetObject.GetComponent<UIGauge>().HealthVariables != null ||
                    targetObject.GetComponent<UIGauge>().ManaVariables != null ||
                    targetObject.GetComponent<UIGauge>().ExpVariables != null ||
                    targetObject.GetComponent<UIGauge>().TimeVariables != null ||
                    targetObject.GetComponent<UIGauge>().ScoreVariables != null ||
                    targetObject.GetComponent<UIGauge>().IntVariables != null ||
                    targetObject.GetComponent<UIGauge>().FloatVariables != null ||
                    targetObject.GetComponent<UIGauge>().StringVariables != null ||
                    targetObject.GetComponent<UIGauge>().BoolVariables != null)
                {
                    aColor = GREEN;
                }
                else { aColor = RED; }
            ...
            else if (targetObject.GetComponent<UIDialog>())
            {
                if (targetObject.GetComponent<UIDialog>().isEnabled) { aColor = GREEN; } else { aColor = RED; }
                aInVPos.y += yOffset; result = true;
                aObject = VIEW;
            }
