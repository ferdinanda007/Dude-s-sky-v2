...
namespace Zetcil
{
    public class VariableModelDebugger : EditorWindow
    {
        ...
        [MenuItem("Zetcil/Framework Debugger/Variable Model %F1", false, 6031)]
        private static void OpenWindow()
        {
            VariableModelDebugger window = GetWindow<VariableModelDebugger>();
